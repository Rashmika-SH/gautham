...
export const defaultSEO: SEOConfig = {
  title: "Master Gautham - Best Astrologer & Psychic Reader | Expert Vedic Astrology Services USA",
  description: "Master Gautham, Best Astrologer & Psychic Reader Gautham offers personalized horoscope readings, black magic removal, spiritual healing, and vashikaran services in Charlotte, North Carolina, USA. 30+ years experience.",
  keywords: [
    "master gautham",
    "best astrologer psychic reader gautham",
    "vedic astrology USA",
    "horoscope reading",
    "black magic removal",
    "spiritual healing",
    ...
    "astrology Charlotte",
    "astrology Charlotte",
    "astrology Charlotte, North Carolina",
    "best astrologer USA",
...
export const pageSEO = {
  home: {
    title: "Master Gautham - Best Astrologer & Psychic Reader in Charlotte, North Carolina, USA | Expert Spiritual Guidance",
    description: "Master Gautham, Best Astrologer & Psychic Reader Gautham provides expert Vedic astrology services in Charlotte, North Carolina, USA. Specializing in horoscope reading, love problem solutions, black magic removal & spiritual healing.",
    keywords: [
      "best astrologer USA",
      "vedic astrology services",
      "master gautham",
      "best astrologer psychic reader gautham",
      "horoscope reading USA",
      "spiritual guidance",
  ...
  about: {
    title: "About Master Gautham - 30+ Years Vedic Astrology Expert USA",
    description: "Learn about Master Gautham's 30+ years journey in Vedic astrology. Expert in spiritual healing, vashikaran, and providing life guidance in Charlotte, North Carolina, USA.",
    keywords: [
      "master gautham biography",
      "best astrologer psychic reader gautham",
      "vedic astrology expert",
      "experienced astrologer USA",
      "spiritual healer",
      "astrology consultant"
    ]
  },
  contact: {
    title: "Contact Master Gautham - Book Consultation | Charlotte, North Carolina",
    description: "Contact Master Gautham, Best Astrologer & Psychic Reader Gautham for personalized consultations. Available in Charlotte, North Carolina, USA. Call +1(704)236-6628 for immediate guidance.",
    keywords: [
      "contact astrologer",
      "book astrology consultation",
      "astrologer Charlotte",
      "astrologer Charlotte",
      "astrologer Charlotte, North Carolina",
